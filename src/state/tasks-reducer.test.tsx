...
test('title of task should be changed', () => {
    const action = changeTaskTitleAC('Something', '2', "todolistId1");
    const endState = tasksReducer(startState, action)

    expect(endState['todolistId1'][1].title).toBe('Something');
})
...
test('empty array shoud be added when we set todolist', () => {
